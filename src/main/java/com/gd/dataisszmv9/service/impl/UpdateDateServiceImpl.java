package com.gd.dataisszmv9.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.gd.dataisszmv9.service.UpdateDateService;
import com.gd.dataisszmv9.entity.*;
import com.gd.dataisszmv9.mapper.*;
...
public class UpdateDateServiceImpl implements UpdateDateService {
    ...
    @Override
    public String queryVisaFlow(BigDecimal flowId) {
        List<TRmVipSavelist> visaFlows= tRmVipSavelistMapper.selectVisaFlows(flowId);
    ...
    @Override
    public String querySaleDetail(Date date) {
        List<TRmSaleFlowInfo> tPosSales = tRmSaleflowMapper.selectSaleDetail(date);
    ...
    @Override
    public String queryCardPaylist(Date date) {
        List<TRmVipSavelist> tVipFlowList = tRmVipSavelistMapper.selectCarPayList(date);
        JSONArray tVipFlows = new JSONArray();
        for (TRmVipSavelist tVipFlow : tVipFlowList) {
...
//            itemInfoDate = stockInfo.getModifyDate();
    ...
    @Override
    public String queryOrderDetail(Date date) {
        List<TRmPayflow> tOrderDetailList = tRmPayflowMapper.selectOrderDetail(date);
        ...
        for (TRmPayflow detail : tOrderDetailList) {
            ...
            tOrderDetail.add(detail.getCardId());
